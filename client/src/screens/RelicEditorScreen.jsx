...
                                                        AMOUNT: { shadow: { type: 'math_number', fields: { NUM: 3 } } }  
                                                    }  
                                                }  
                                            }  
                                        }  
...
{ 
        ...
        workspace: { 
            blocks: { blocks: [ // 👈 修复：包上了一层 blocks
                { 
                    type: 'hook_onDamageDealt', // 👈 修复：更新为新名字
                    x: 30, y: 30, 
                    inputs: { 
                        BODY: { 
                            block: { 
                                ...
                                inputs: { 
                                    BODY: { 
                                        block: { 
                                            type: 'action_apply_damage', // 👈 修复：更新为新名字
                                            fields: { IS_NORMAL: 'false' }, // 👈 修复：更新布尔值为小写
                                            inputs: { 
                                                TARGET: { block: { type: 'player_loop_target' } }, 
                                                DAMAGE: { shadow: { type: 'math_number', fields: { NUM: 0.5 } } } // 👈 修复：参数名改为 DAMAGE
                                            } 
                                        } 
                                    } 
                                } 
    ...
    { 
        ...
        workspace: { 
            blocks: { blocks: [ // 👈 修复：包上了一层 blocks
                { 
                    type: 'hook_modifyOutgoingDamage', // 👈 修复：更新为新名字
                    x: 30, y: 30, 
                    inputs: { 
                        BODY: { 
                            block: { 
    ...
    { 
        ...
        workspace: { 
            blocks: { blocks: [ // 👈 修复：包上了一层 blocks
                { 
                    type: 'hook_onGameStart', // 👈 修复：更新为新名字
                    x: 30, y: 30, 
                    inputs: { 
                        BODY: { 
                            block: { 
                                type: 'set_prop_number', // 👈 修复：更新为新名字
                                fields: { PROP: 'maxHp' }, 
                                inputs: { 
